...
# Seuils de confiance
CONF_HIGH   = 0.80   # Confiance haute → voie directe possible
CONF_MEDIUM = 0.60   # Confiance moyenne → agents requis
# < CONF_MEDIUM → confiance faible → tous agents + manuel si désaccord

# Seuil OCR : en dessous → image considérée dégradée
OCR_QUALITY_THRESHOLD = 0.30
OCR_MIN_LENGTH        = 200   # chars minimum pour éviter re-OCR inutile
